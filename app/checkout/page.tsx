                ...
                <div className="order-2 lg:order-1">
                    ...
                    <div className="mt-6 flex rounded-md shadow-sm">
                        <button
                            ...
                            className={`relative flex-1 px-4 py-2 text-sm font-medium rounded-l-md border focus:z-10 focus:outline-none ${
                        ...
                        <button
                            ...
                            className={`relative flex-1 px-4 py-2 text-sm font-medium rounded-r-md border-t border-b border-r focus:z-10 focus:outline-none ${
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        ...
                        <div className="sm:col-span-2 mt-6">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div 
                                    ...
                                    className={`relative flex cursor-pointer flex-col rounded-lg border p-4 shadow-sm focus:outline-none ${
                        ...
                        <div className="sm:col-span-2 mt-8">
                            ...
                            >
                                {isLoading ? 'Processing...' : `Place Order - ${(cartTotal + (shippingMethod === 'easybox' ? 12 : 19)).toFixed(2)} RON`}
                            </button>
                        </div>
                    </form>
                </div>
                    ...
                    <div className="sticky top-32 rounded-lg border border-stone-200 bg-white p-6 shadow-sm dark:border-stone-800 dark:bg-stone-900">
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col">
                                        <div>
                                            <div className="flex justify-between text-base font-medium text-stone-900 dark:text-white">
                                                <h3>{item.name}</h3>
                                                <p className="ml-4">{(parseFloat(item.price.replace(',', '.')) * item.quantity).toFixed(2)} {item.currency}</p>
                                            </div>
                                        </div>
                        ...
                        <div className="mt-6 border-t border-stone-200 pt-6 dark:border-stone-700">
                            ...
                            <div className="mt-6 flex items-center justify-between border-t border-stone-200 pt-6 text-base font-medium text-stone-900 dark:border-stone-700 dark:text-white">
                                <p>Total</p>
                                <p>{(cartTotal + (shippingMethod === 'easybox' ? 12 : 19)).toFixed(2).replace('.', ',')} RON</p>
                            </div>
                        </div>
                    </div>
                </div>
