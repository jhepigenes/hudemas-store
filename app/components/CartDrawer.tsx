                                ...
                                {items.length === 0 ? (
                                    ...
                                    <ul className="space-y-8">
                                        {items.map((item) => {
                                            ...
                                            return (
                                                <li key={item.name} className="flex gap-6 p-4 bg-stone-50 dark:bg-stone-800/30 rounded-xl border border-stone-200 dark:border-stone-700 shadow-sm">
                                                    <div className="relative h-36 w-36 flex-shrink-0 overflow-hidden rounded-lg bg-white border border-stone-200 dark:border-stone-700">
                                                        <Image
                                                            src={item.image}
                                                            alt={item.name}
                                                            fill
                                                    ...
                                                    <div className="flex flex-1 flex-col justify-between py-1">
                                                        <div>
                                                            <h3 className="font-serif text-2xl font-bold text-stone-900 dark:text-white leading-tight">
                                                                {item.name}
                                                            </h3>
                                                            <p className="text-xl font-medium text-stone-600 dark:text-stone-300 mt-2">
                                                                {formatPrice(priceNum)}
                                                            </p>
                                                        </div>
                                                        <div className="flex items-center justify-between mt-4">
                                                            <div className="flex items-center gap-4 rounded-full border border-stone-200 px-5 py-3 dark:border-stone-700 bg-white dark:bg-stone-900">
                                                                <button
                                                            ...
                                                            <button
                                                                ...
                                                                className="p-4 text-stone-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-full transition-colors"
